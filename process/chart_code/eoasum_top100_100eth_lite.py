# lite version of eoasum_top100_100eth.py: total balance of top 100 EOA
# (>= 100 ETH) per day.
#
...
#
# run from process/:  python3 chart_code/eoasum_top100_100eth_lite.py
import os
import glob

output_path = "chart_data/eoasum_top100_100eth.txt"
...
for file in todo:
    ...
    for line in lines:
        ...
        if arr[0] not in contracts:
            balances.append(int(arr[2]))
    balances.sort(reverse=True)
    results[day] = str(sum(balances[:100]) / (10**18))
