# lite version of eoacnt_100eth.py: count of EOA (>= 100 ETH) per day.
#
...
#
# run from process/:  python3 chart_code/eoacnt_100eth_lite.py
import os
import glob

output_path = "chart_data/eoacnt_100eth.txt"
